export default function Support() {
  return (
    <section id="sostienici" className="relative py-24 overflow-hidden bg-white">
      {/* Decorative clean background using soft blur, matching general page styling */}
      ...
      <div className="container-custom relative z-10">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-lg font-sans">
            ...
            <div className="flex gap-8 pt-2">
              <div className="text-center">
                <div className="text-3xl font-extrabold text-[#0b3c82] tracking-tight font-display">100%</div>
                <div className="text-xs text-gray-500 font-semibold font-sans mt-1">Trasparenza</div>
              </div>
              <div className="w-px bg-gray-200"></div>
              <div className="text-center">
                <div className="text-3xl font-extrabold text-[#0b3c82] tracking-tight font-display">500+</div>
                <div className="text-xs text-gray-500 font-semibold font-sans mt-1">Famiglie aiutate</div>
              </div>
              <div className="w-px bg-gray-200"></div>
              <div className="text-center">
                <div className="text-3xl font-extrabold text-[#0b3c82] tracking-tight font-display">10+</div>
                <div className="text-xs text-gray-500 font-semibold font-sans mt-1">Anni di attività</div>
              </div>
            </div>

            {/* CTA Button - consistent with other page buttons */}
            <div className="pt-4">
              <a 
                href="/sostienici" 
                className="group inline-flex items-center gap-3 px-8 py-4 bg-[#0b3c82] text-white rounded-full font-semibold text-lg hover:bg-[#e30613] transition-all duration-300 shadow-md hover:shadow-lg font-sans"
              >
          ...
          <div className="hidden md:flex justify-center">
            <div className="relative">
              {/* Glowing heart icon in light mode theme */}
              ...
              {/* Floating badges in light theme */}
